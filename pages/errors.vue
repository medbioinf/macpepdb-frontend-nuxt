<template>
    <div class="error-page">
        ...
        <p>
            If you encounter an error multiple times, it would be great if you would file an issue on <a target="_blank" href="https://github.com/mpc-bioinformatics/macpepdb-web/issues">https://github.com/mpc-bioinformatics/macpepdb-web</a>.
